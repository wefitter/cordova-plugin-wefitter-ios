...
typedef SWIFT_ENUM(NSInteger, WeFitterHealthKitDataType, open) {
  ...
  WeFitterHealthKitDataTypeAppleExerciseTime = 1,
  WeFitterHealthKitDataTypeAppleMoveTime = 2,
  WeFitterHealthKitDataTypeBasalEnergyBurned = 3,
  WeFitterHealthKitDataTypeBloodGlucose = 4,
  WeFitterHealthKitDataTypeBloodPressureDiastolic = 5,
  WeFitterHealthKitDataTypeBloodPressureSystolic = 6,
  WeFitterHealthKitDataTypeBodyFatPercentage = 7,
  WeFitterHealthKitDataTypeBodyMass = 8,
  WeFitterHealthKitDataTypeBodyMassIndex = 9,
  WeFitterHealthKitDataTypeBodyTemperature = 10,
  WeFitterHealthKitDataTypeCyclingCadence = 11,
  WeFitterHealthKitDataTypeCyclingPower = 12,
  WeFitterHealthKitDataTypeCyclingSpeed = 13,
  WeFitterHealthKitDataTypeDistanceCycling = 14,
  WeFitterHealthKitDataTypeDistanceDownhillSnowSports = 15,
  WeFitterHealthKitDataTypeDistanceSwimming = 16,
  WeFitterHealthKitDataTypeDistanceWalkingRunning = 17,
  WeFitterHealthKitDataTypeDistanceWheelchair = 18,
  WeFitterHealthKitDataTypeElectrocardiogram = 19,
  WeFitterHealthKitDataTypeHeartRate = 20,
  WeFitterHealthKitDataTypeHeartRateVariabilitySDNN = 21,
  WeFitterHealthKitDataTypeHeight = 22,
  WeFitterHealthKitDataTypeMindfulSession = 23,
  WeFitterHealthKitDataTypeOxygenSaturation = 24,
  WeFitterHealthKitDataTypeRestingHeartRate = 25,
  WeFitterHealthKitDataTypeRunningPower = 26,
  WeFitterHealthKitDataTypeRunningSpeed = 27,
  WeFitterHealthKitDataTypeSleepAnalysis = 28,
  WeFitterHealthKitDataTypeStairAscentSpeed = 29,
  WeFitterHealthKitDataTypeStairDescentSpeed = 30,
  WeFitterHealthKitDataTypeStepCount = 31,
  WeFitterHealthKitDataTypeVo2Max = 32,
  WeFitterHealthKitDataTypeWalkingSpeed = 33,
  WeFitterHealthKitDataTypeWorkout = 34,
};
